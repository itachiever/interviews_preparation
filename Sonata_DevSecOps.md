...
Mandatory Skills
IAM, networking, CI/CD pipelines in GitLab, CloudFormation, OpenTufu, Docker, Kubernetes, EKS, GitLab security scanning
...
• Experience with policy-as-code tools (OPA, Sentinel, AWS Config rules)  code tools (OPA, Sentinel, AWS Config rules)
